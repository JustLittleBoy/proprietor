...
class Proprietor
{
	...
	public static function Init()
	{
		...
		//自动注册类
		spl_autoload_register(array('Proprietor','classAutoLoader'));
		
		//注册错误屏蔽
		if(!DEBUG){
			set_exception_handler(array('Proprietor','exceptionHandler'));
			set_error_handler(array('Proprietor','errorHandler'),E_ALL);
		}
		
		register_shutdown_function(array('Proprietor','shutdownCatchError'));
